...
# UnSplit38
A 38-key (un)split keyboard built around a single Nice!Nano. Based on my [split38](https://github.com/JoeyDrew/split38) project. Currently a PCB-less/handwired design.

This repository contains related ZMK configuration, KiCAD project, and plate DXF file. 
